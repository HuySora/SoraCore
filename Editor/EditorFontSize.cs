// https://github.com/punchdoby/unity-editor-scripts/blob/main/EditorScripts/EditorFontSize.cs
using System;
...
Everything will be under Tools > SoraCore > Editor Font Size. Changes are reflected and snapshotted instantly.
...
*/
namespace SoraCore.Editor
{
    public sealed class EditorFontSize : EditorWindow {
        private static EditorFontSize m_Instance;
        // ---------------------- Config ----------------------
        ...
        // ---------------------- Menu ------------------------
        [MenuItem("Tools/SoraCore/Editor Font Size/Open Window")]
        private static void Open()
        {
            if (m_Instance == null) {
                m_Instance = GetWindow<EditorFontSize>("Editor Font Size");
                m_Instance.minSize = new Vector2(480, 640);
            }
            else {
                m_Instance.Focus();
            }
        ...
        [MenuItem("Tools/SoraCore/Editor Font Size/Reset Global Zoom")]
        ...
        [MenuItem("Tools/SoraCore/Editor Font Size/Snapshots/Rebuild Defaults From Current Editor")]
        ...
        [MenuItem("Tools/SoraCore/Editor Font Size/Snapshots/Reset Current To Defaults")]
        ...
        [MenuItem("Tools/SoraCore/Editor Font Size/Snapshots/Open Settings Folder")]
